...
# Prefer a robust default that doesn't depend on native bcrypt,
# but allow verifying bcrypt hashes if present.
PASSWORD_SCHEMES = os.getenv("PASSWORD_SCHEMES", "pbkdf2_sha256,bcrypt").split(",")
